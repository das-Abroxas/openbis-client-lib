...
public interface IOpenBisClient {
   ...
   * @return sample
   */
  Sample getSamplesWithParentsAndChildren(String sampCode);
   ...
   * @return list with all datasets of the given sample
   */
  List<DataSet> getDataSetsOfSampleByCode(
          String sampleCode);
   ...
   */
  List<DataSet> getDataSetsOfSpace(
      String spaceCode);

  /**
   * Function to list all datasets of a specific openBIS project
   *
   * @param projectCodeOrIdentifier identifier of the openBIS project
   * @return list with all datasets of the given project
   */
  List<DataSet> getDataSetsOfProject(
      String projectCodeOrIdentifier);
   ...
   */
  Set<String> getSpaceMembers(String spaceCode);
   ...
   */
  List<PropertyType> listPropertiesForType(IEntityType entity_type);
   ...
   */
  String triggerIngestionService(String serviceName, Map<String, Object> parameters);
   ...
   * @return Map<Sample,List> mapping between children and parents of samples
   */
   ...
   */
  Sample getSampleByCode(String sampleCode);
}
